...
//服务器端的业务处理类(读/写数据)
public class NettyServerHandler extends ChannelInboundHandlerAdapter { // Inbound 服务器端主要是读数据 所以是In
    ...
    public void channelReadComplete(ChannelHandlerContext ctx){
        ctx.writeAndFlush(Unpooled.copiedBuffer("No meney",CharsetUtil.UTF_8));
    }
